...
@NamedQueries({
    ...
    @NamedQuery(name = "Supplier.findAllByName", query = "SELECT s FROM Supplier s WHERE s.name like :name"),
    @NamedQuery(name = "Supplier.findByShopname", query = "SELECT s FROM Supplier s WHERE s.shopname = :shopname"),
    @NamedQuery(name = "Supplier.findByContact1", query = "SELECT s FROM Supplier s WHERE s.contact1 = :contact1"),
    @NamedQuery(name = "Supplier.findByContact2", query = "SELECT s FROM Supplier s WHERE s.contact2 = :contact2")})
