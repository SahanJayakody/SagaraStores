...
//</editor-fold>
    ...
    private void btnUpdateAP(ActionEvent event) {
        ...
        if (errors.isEmpty()) {
            ...
            if (!updates.isEmpty()) {
                ...
                Action action = Dialogs.create().title("Confirm Message").masthead("Privilege Update").message(updates).showConfirm();
                ...
                Dialogs.create().title("Information Message").masthead("Privilege Update").message("Nothing Updated").showWarning();
            }
        } else {

            Dialogs.create().title("Error Message").masthead("Privilege Update").message(getErrors()).showError();
    ...
    private void btnDeleteAP(ActionEvent event) {
        if (getUpdates().isEmpty() && getErrors().isEmpty()) {
            ...
            Action action = Dialogs.create().title("Privilege Delete").masthead(privilege.toString() + " Delete ?").message("Do you need to delete this privilege").showConfirm();
            ...
            Dialogs.create().title("Privilege Delete").masthead(oldPrivilege.toString() + " Delete ?").message("You can't delete\nSome of the fields are updated").showInformation();
    ...
    private void btnAddAP(ActionEvent event) {
        ...
        if (errors.isEmpty()) {
            ...
            String confermation = "Are you sure you need to add this Privileges with following details\n "
            ...
            Action action = Dialogs.create().title("Confirm Message").masthead("Privilege Add").message(confermation).showConfirm();
            if (action.toString().equals("DialogAction.YES")) {

                try {

                    PrivilageDao.add(privilege);
                    Notifications.create().title("Successs").text("Privilege of" + privilege.toString() + " saved.").position(Pos.TOP_RIGHT).hideAfter(Duration.seconds(5.0)).showInformation();
                    loadForm();
                    fillTable(PrivilageDao.getAll());
            ...
            Dialogs.create().title("Error Message").masthead("Privilege Detail Error").message(errors).showError();
